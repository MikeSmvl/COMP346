...
public class BlockManager
{
	 ...
	 */
	private static Semaphore s2 = new Semaphore(1); // Added semaphore s2
	...
	static class AcquireBlock extends BaseThread
	{
		...
		public void run()
		{
			...
			s1.V();
			s1.P();
			s1.V(); // This line makes sure all phase 1's have completed and then signals each to go
			s2.P(); // From this point, only one thread can enter phase 2 at a time
			
			// This allows other threads a chance to check their turn
